...
const PROJECTS = [
  {
    ...
    links: [
      ...
      { label: 'Code', href: 'https://github.com/Gensune' }
    ],
        ...
        <div className='container'>
          ...
          >
            <p className='has-text-grey-light'>
              ...
              email <a href='mailto:hello@gensune.dev'>hello@gensune.dev</a>.
            </p>
          </div>
        </div>
      </section>
